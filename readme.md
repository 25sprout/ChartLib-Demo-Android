...
![Alt text](./1447038568088.png)

本篇文章將會依序介紹這五個類別的用法，我們先來看一個基本圖表會如下圖：

![Alt text](./chart-intro.png)
...
1. **摺線圖 LineChart** ![Alt text](./1447056445988.png)
2. **長條圖 BarChart** ![Alt text](./1447056370327.png)
3. **長條摺線圖 Combined-Chart**  ![Alt text](./1447056347376.png)
4. **圓餅圖 PieChart** ![Alt text](./1447056415729.png)
5. **雷達圖 ScatterChart** ![Alt text](./1447056465848.png)
6. **K線圖 CandleStickChart** ![Alt text](./1447056571061.png)
7. **泡泡圖 BubbleChart** ![Alt text](./1447056582819.png)
8. **雷達圖 RadarChart** ![Alt text](./1447056847896.png)
...
Chart 用 `LineData` 作為封裝所有資料的物件，並有 `DataSet`、`Entry`、`XVals` 等不同的元件，以下圖 LineChart 來說明基本概念：
 ...
 ![Alt text](./mpandroid-dataset.PNG)
...
![Alt text](./1447403990447.png)
```java
dataSet.setLineWidth(5f);
```
![Alt text](./1447643754807.png)
```java
...
![Alt text](./1447911795374.png)

<br>
<a div="取得Legend圖例區與設定位置"></div>
> **取得 Legend圖例區與設定位置**

![Alt text](./1447917024871.png)
...
1. **CIRCLE** ![Alt text](./1447917593570.png)
2. **SQUARE（預設）**![Alt text](./1447917650698.png)
3. **LINE** ![Alt text](./1447917665616.png)
